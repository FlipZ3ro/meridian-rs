...
// study, smart-wallet checks) only add slow LLM round-trips and delay
// deployment. They are kept out of the screener so it goes straight from
// get_top_candidates → deploy_position for fast fee-printing rotation.
